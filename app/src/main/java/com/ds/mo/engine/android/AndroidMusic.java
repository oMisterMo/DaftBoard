...
//            System.out.println("Trouble playing : error code 202");
    ...
    /**
     * Checks whether the media player is currently playing
     *
    ...
    /**
     * Checks if media player is looping
     *
     ...
     *
     * @return true if media player has been stopped
     */
    @Override
    ...
    /**
     * Stops media player and releases memory
     */
    @Override
    public void dispose() {
        if (mediaPlayer != null) {
