...
public interface Graphics {
     ...
     *
     * @param color color in hex form (0x0000ff)
     */
     ...
     * @param x     position
     * @param y     position
     * @param color color of pixel (argb)
     */
     ...
     * @param x2    end x
     * @param y2    end y
     * @param color color of line (argb)
     */
    void drawLine(int x, int y, int x2, int y2, int color);

    /**
     * Draws a filled in rectangle at the given location
     *
     * @param x      start x
     * @param y      start y
     * @param width  width of rect
     * @param height height of rect
     * @param color  color of rect (argb)
     */
    void drawRect(int x, int y, int width, int height, int color);

    void drawRect(int x, int y, int width, int height, Paint p);
